  ...
  <div style="overflow-x:auto;">
    <div class="container py-5 h-200">
      ...
      <div class="d-flex justify-content-center mb-2 img-container">
        <img src="./assets/img/banner_img_03.jpg" alt="Al-Razi Advisers">
    </div>
                  <h6 class="mb-2 text-warning" style="font-size: 25px;">Al-Razi</h6>
    ...
    <!-- You can add more mock posts here if needed -->
          ...
          <div class="d-flex justify-content-center">
            <table class="table" style="text-align: center; font-size: 10px;">
              <thead style="background-color: #eebe1c; color: white;">
                <tr>
                  <th scope="col">#</th>
