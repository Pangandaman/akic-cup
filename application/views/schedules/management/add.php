...
<head>
    <title>Add Program Schedule</title>
...
<body>
    <header class="hero">
        <div class="hero-wrap">
            <p class="intro" id="intro">Add Program</p>
    ...
    <!--start content-->
                        ...
                        <div class="card-body p-4 p-md-5">
                            <h3 class="mb-4 pb-2 pb-md-0 mb-md-5">Add a Program Schedule</h3>
                            <form id="scheduleForm" action="process_schedule.php" method="post">
                                <div class="row mb-4">
                                    <div class="col-6">
                                        <h6 class="mb-2 text-primary">Program</h6>
                                        <input type="text" class="form-control" name="program" placeholder="Name" required>
                                    </div>
                                    <div class="col-6">
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-6">
                                        <div class="form-outline">
                                            ...
                                            <input type="text" class="form-control" name="venue" placeholder="Location" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-outline">
    ...
    <div class="form-outline">
        ...
        <input type="checkbox" id="attendanceRequired" name="attendanceRequired">
    </div>
</div>
