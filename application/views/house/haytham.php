  ...
  <div style="overflow-x:auto;">
    <div class="container py-5 h-200">
      ...
      <div class="d-flex justify-content-center mb-2 img-container">
        <img src="./assets/img/banner_img_04.jpg" alt="Al-Razi Advisers">
    </div>
                  <h6 class="mb-2 text-primary" style="font-size: 25px;">Al-Haytham</h6>
...
<div class="AdviserList">
    ...
    <h1 class="update-heading"><i class="fa fa-users" aria-hidden="true"></i><br>Assign<br> House Advisers</h1>
    </a></td>
</div>
<script>
...
?>
                              ...
                              <tr>
                                 <th>Facebook:</th>
                                 <td>www.facebook.com/<br>alhaytham</td>
                              </tr>
                              <tr>
                                 <th>Total Members:</th>
                                 <td>322</td>
    ...
    <!-- You can add more mock posts here if needed -->
          ...
          <div class="d-flex justify-content-center">
            <table class="table" style="text-align: center; font-size: 10px;">
              <thead style="background-color: #1263a6; color: white;">
                <tr>
                  <th scope="col">#</th>
