...
<html lang="en">
  ...
  <header class="hero">
    <div class="hero-wrap">
      <p class="intro" id="intro">Single-Elimination</p>
...
<iframe id="externalIframe" src="https://challonge.com/6rvmtrrs/module" width="100%" height="500" frameborder="0" scrolling="auto" allowtransparency="true"></iframe>
  <script>
