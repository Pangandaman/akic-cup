            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item ml-auto dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDarkDropdownMenuLink">
                     ...
                     <li>
                        <a class="dropdown-item" style="cursor:pointer;" href="index.php?c=Content&m=view_students" onMouseOver="this.style.color='grey'" onMouseOut="this.style.color='white'">Students</a>
                    </li>
                     <li>
